...
class Server:
    ...
    @event_log
    def _client_handler(self, connection: socket.socket) -> str:
        ...
        while True:
            try:
                ...
                return f"{client_data.nickname} disconnected"
    ...
    @event_log
    def _send_message_to_all(self, sender_data: ClientData, message: str) -> str:
    ...
    def _create_new_connection_thread(self, connection: socket.socket) -> threading.Thread:
    ...
    @event_log
    def _create_new_client(self, connection: socket.socket) -> str:
